class JoinTableForMemberFriendships < ActiveRecord::Migration[5.2]
  def change
    ...
    # But for this case, since you are doing smth out of the norm (self-joining using a single model), you need to create a table manually and then tell it not to create an id column.
